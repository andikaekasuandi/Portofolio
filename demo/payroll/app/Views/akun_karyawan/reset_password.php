...
<div class="page-header">
    <div class="page-header-left">
        ...
        <div>
            <div class="page-header-title">Reset Password Karyawan</div>
...
<div class="card shadow-sm">
    <div class="card-body">
        <form method="post" action="<?= site_url('akun-karyawan/reset-password/' . $resetRequest['id_request']) ?>">
            <?= csrf_field() ?>
            ...
            <div class="mb-3">
                ...
                <div class="form-text">Sampaikan password ini ke Karyawan yang bersangkutan secara langsung (WA/lisan) setelah disimpan.</div>
            </div>
